...
namespace App\Filament\Resources\TenantProfiles\Schemas;
...
/**
 * Creates the tenant's `Party` record and `TenantProfile` together in one
 * screen — `name`/`phone`/`email` here are Party fields, not TenantProfile
 * columns; the page classes (Create/EditTenantProfile) split them back apart.
