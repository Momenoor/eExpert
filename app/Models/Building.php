...
class Building extends Model
{
    ...
    /**
     * The parties (in the 'owner' role) holding a stake in this building.
     *
     * @return BelongsToMany<Party, $this>
     */
    public function owners(): BelongsToMany
    {
        return $this->belongsToMany(Party::class, 'owner_building', 'building_id', 'owner_party_id')
     ...
     *
     * When every owner on this building belongs to the same `OwnerGroup` —
